// https://github.com/rutura/The-C-20-Masterclass-Source-Code/blob/main/04.VariablesAndDatatypes/4.5FractionalNumbers/main.cpp
// https://www.youtube.com/watch?v=8jLOx1hD3_o&t=14040s
...
int main(){
    ...
    float number1 {1.012345678901234567890f}; // Precision : 7
    double number2 {1.012345678901234567890}; // Precision : 15
    long double number3  {1.012345678901234567890L};
    ...
    float number4 = 123456789.0f;               // Error : narrowing conversion

    std::cout << "number4 123456789.0f: " << number4 << std::endl;
